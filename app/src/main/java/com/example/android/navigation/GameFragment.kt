...
//                        view.findNavController().navigate(R.id.action_gameFragment_to_gameWonFragment) //explicitly action version
                        view.findNavController().navigate(GameFragmentDirections.actionGameFragmentToGameWonFragment(numQuestions, questionIndex)) //navDirection version
                    }
                } else {
